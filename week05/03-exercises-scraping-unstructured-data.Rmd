...
```{r}
first_caption_element <- html_noether %>% html_elements(css = "#mw-content-text > div.mw-content-ltr.mw-parser-output > figure:nth-child(11) > figcaption")
...
```{r}
all_lhs_caption_elements <- html_noether %>% html_elements(css = ".mw-default-size.mw-halign-left figcaption")
...
```{r}
data_feynman[labels_feynman=="Education"] <- str_replace_all(data_feynman[labels_feynman=="Education"], "^.+?\n", "")
print(data_feynman[labels_feynman=="Education"])
```
